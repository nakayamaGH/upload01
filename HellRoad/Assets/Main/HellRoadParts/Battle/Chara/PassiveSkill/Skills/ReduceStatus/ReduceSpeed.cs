...
{
    public class ReduceSpeed : AddStatusPassiveSkill
	{
		public override PassiveSkillID ID => PassiveSkillID.ReduceSpeed;
		public override When When => When.OnAddSkill;
		public override Who Who => Who.Me;

		public ReduceSpeed() : base(StatusParamType.Speed, -0.2f)
		{
		}
